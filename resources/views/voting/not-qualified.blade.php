...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-red-500 to-red-700 px-6 py-8 text-white text-center">
            ...
            <h1 class="text-3xl font-bold mb-2">You're Registered!</h1>
            <p class="text-red-100">You are officially registered. However, you are not qualified to vote at this time.</p>
        </div>
